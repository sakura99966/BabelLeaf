...
import { ollamaTranslator, openAICompatibleTranslator, type LLMTranslatorName } from './llm';

const availableTranslators = [ollamaTranslator, openAICompatibleTranslator] as const;
