...
import { DEFAULT_PARAGRAPH_GAP_SEC } from './tts/constants';
...
export const DEFAULT_SYSTEM_SETTINGS: Partial<SystemSettings> = {
  ...
  customDictionaries: [],
  dictionarySettings: {
    providerOrder: ['builtin:system'],
    providerEnabled: { 'builtin:system': false },
  },
...
export const DEFAULT_MOBILE_SYSTEM_SETTINGS: Partial<SystemSettings> = {
  ...
  // default so they persist instead of opening them transiently.
