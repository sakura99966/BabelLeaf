...
BabelLeaf uses a **key-as-content** approach: English strings are the
translation keys. The English locale (`en/translation.json`) is empty because
keys serve as content. Other locales contain actual translations.
