# BabelLeaf 0.3.2 performance baseline
...
the startup path. A benchmark must record OS, CPU, RAM, package revision,
fixture hash, provider mode, worker count, peak memory, and cache size.
